...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "magi"; //Local Storage Names for PWA
    ...
    function init_template(){
        ...
        */
        ...
        let plugins = [
          ...
          {
            id: 'apex-chart',
            call: 'apexChart/apexChart.js',
            call: 'apexChart/gridData.js',
            trigger: '#eum-table'
          },
          {
            id: 'rolldate',
            plug: 'rolldate/rolldate.min.js',
            call: 'rolldate/rolldate-call.js',
            style: 'rolldate/rolldate.css',
            trigger: '#example'
          },
          {
            id: 'filter',
